...
function format(a) { return `£${a}`}

const startingValue =2;

// Why can this code be seen as bad practice? 

// Because if we use it in different places and  then we want to change it   we will have to change all of them one by one . But by using a function changing the code or adding something to it is easier   and we only need  to do it once and if we have too much code it will be hard  and long to write it like this and it will be difficult for other  people    to  understand .
