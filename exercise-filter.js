...
const pairsByIndexRaw = [[0, 3], [1, 2], [2, 1], null, [1], false,"oo", 'whoops'];

let pairsByIndex =pairsByIndexRaw.filter((val)=> Array.isArray(val) && val.length===2); // Complete this statement
